...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">ADM </span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../Prison/add_prison.php">
              <i class="bi bi-circle"></i><span> Enregistrer </span>
            </a>
          </li>
          <li>
            <a href="../Prison/liste_prison.php">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../Autorisation/add_autorisation.php">
              <i class="bi bi-circle"></i><span> Enregistrer </span>
            </a>
          </li>
          <li>
            <a href="../Autorisation/liste_autorisations.php">
              <i class="bi bi-circle"></i><span>Listes Autorisation</span>
            </a>
          </li>
          <li>
            <a href="../Autorisation/rechercher.php">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Genuis</span></strong>. All Rights Reserved
    </div>
